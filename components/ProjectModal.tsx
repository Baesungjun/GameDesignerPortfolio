            ...
            {isOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6">
                    ...
                    <motion.div
                        ...
                        className="relative w-full max-w-4xl h-[90vh] bg-slate-900 border border-slate-700 rounded-3xl shadow-2xl overflow-hidden flex flex-col"
                    >
                        ...
                        {/* Scrollable Body */}
                        <div className="flex-1 overflow-y-auto p-6 sm:p-10 space-y-10 custom-scrollbar pb-20">
